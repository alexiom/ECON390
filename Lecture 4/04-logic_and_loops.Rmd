...
author: "Alex Marsh"
date: "University of North Carolina | [ECON 390](https://github.com/uo-ec607)" #"`r format(Sys.time(), '%d %B %Y')`"
output:
...
- Warnings will still allow for code to run, but in most cases, extreme caution should be taken when the warning is triggered.
