...
subtitle: "Lecture 11: Data cleaning & wrangling: Tidyverse"
author: "Alex Marsh"
...
.footnote[
<sup>1</sup> As y'all know, I'm also a huge fan of [**data.table**](http://r-datatable.com/). 
]
...
The `tidyverse` uses a pipe %>% which lets you send (i.e. "pipe") intermediate output to another command.
