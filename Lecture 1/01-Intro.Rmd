...
`r fa('graduation-cap')` Third Year Economics PhD Student (Empirical IO and Applied Econometrics)
...
(Read the full document [here](https://alexmarsh.io/files/ECON390_Fall2021.pdf).)
...
- [Final Project](https://github.com/alexiom/ECON390/tree/main/final_project) 
 - Details TBD.
